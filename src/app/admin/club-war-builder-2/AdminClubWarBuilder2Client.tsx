...
// ⚡ ClubWarBuilder2Client ไฟล์ใหญ่ (~1.8k บรรทัด) — แยก chunk + skeleton
const ClubWarBuilder2Client = dynamic(() => import("./ClubWarBuilder2Client"), {
  ssr: false,
  loading: () => (
...
export default function AdminClubWarBuilder2Client() {
  const meQuery = useMe();
  ...
  return (
    <div className="mx-auto w-full max-w-[1700px] px-4 md:px-6 py-4 space-y-3">
      <div className="flex items-center gap-2">
        <div className="text-lg font-semibold">Club War Builder 2</div>
      ...
      <ClubWarBuilder2Client canEdit={canEdit} />
    </div>
  );
}
